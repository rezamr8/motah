...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Jenisorder</div>
                    <div class="card-body">
                        <a href="{{ url('/admin/jenis-order/create') }}" class="btn btn-success btn-sm" title="Add New JenisOrder">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/admin/jenis-order', 'class' => 'form-inline my-2 my-lg-0 float-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                                ...
                                @foreach($jenisorder as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::open([
                                                'method'=>'DELETE',
                                                'url' => ['/admin/jenis-order', $item->id],
                                                'style' => 'display:inline'
                                            ]) !!}
                                                {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i> Delete', array(
                                                        'type' => 'submit',
                                                        'class' => 'btn btn-danger btn-sm',
                                                        'title' => 'Delete JenisOrder',
                            ...
                            <div class="pagination-wrapper"> {!! $jenisorder->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
